...
export const metadata: Metadata = { title: 'OnlyFans Creator Growth Insights', description: 'Practical strategy for OnlyFans creators: management, marketing, content systems and sustainable growth.', alternates: { canonical: '/insights' } };
