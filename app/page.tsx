...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-aura" /><div className="hero-grid">
      <div className="hero-copy reveal"><p className="eyebrow"><Sparkles size={14} /> OnlyFans &amp; Fansly management agency</p><h1>Create freely.<br /><em>Grow deliberately.</em></h1><p className="hero-lead">Lunelle manages and markets ambitious OnlyFans and Fansly creators—building your brand, operating your profiles and engineering growth while you focus on creating content.</p><div className="hero-actions"><a className="button primary" href="#apply" data-umami-event="Hero apply CTA">Apply privately <ArrowRight size={17} /></a><a className="text-link" href="#system">See how it works <ArrowDownRight size={16} /></a></div><div className="hero-proof"><div><strong>One team</strong><span>around your business</span></div><div><strong>Your voice</strong><span>at every touchpoint</span></div><div><strong>Clear data</strong><span>behind every decision</span></div></div></div>
    ...
    <section className="platform-strip" aria-label="Creator platforms we specialize in"><p>Specialized management for</p><div className="platform-name"><i>OF</i><strong>OnlyFans</strong></div><span>+</span><div className="platform-name fansly"><i>F</i><strong>Fansly</strong></div><small>Independent agency. Not affiliated with or endorsed by either platform.</small></section>
    ...
    <footer><div className="footer-brand"><img src="/lunelle-mark-small.png" alt="" width={28} height={28} loading="lazy" /><span>LUNELLE</span></div><p>Elevate <b>·</b> Empower <b>·</b> Earn</p><div><a href="/insights">Insights</a><span>© 2026 Lunelle Management</span></div><small>OnlyFans and Fansly are trademarks of their respective owners. Lunelle Management is an independent agency and is not affiliated with or endorsed by either platform.</small></footer>
  </main>;
}
