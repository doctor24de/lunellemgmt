...
export default function Home() {
  ...
  return <main>
    ...
    <section className="platform-strip" aria-label="OnlyFans creator management"><div><span>Built for ambitious creators on</span><img src="/onlyfans-logo.svg" alt="OnlyFans" width={256} height={45} /></div><h2>Own your brand. Expand your influence.<br /><em>Apply to elevate.</em></h2><a href="#apply">Become a Lunelle creator <ArrowRight size={17} /></a></section>
    ...
    <section className="global-reach"><div className="global-copy"><p className="section-label light">Global creator management</p><h2>Where ambition lives,<br /><em>Lunelle operates.</em></h2><p>One discreet, remote-first management team supporting ambitious OnlyFans creators across the world&apos;s most influential creative markets.</p></div><div className="location-list" aria-label="Markets served by Lunelle Management"><span>Miami</span><span>Los Angeles</span><span>New York City</span><span>Colombia</span><span>Bali</span><span>Ibiza</span><span>Rio de Janeiro</span><strong>Worldwide ✦</strong></div></section>
